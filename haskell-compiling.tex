...
\pgfdeclareimage[height=3cm]{unpack}{img/unpack}
...
\begin{frame}{Factorial Function}
  \input{code/factorial.hs}
\end{frame}

\begin{frame}{Factorial Function}
  \input{code/factorial-main.hs}
\end{frame}

\againframe{comp-pipeline}

\begin{frame}{Tracing The Compilation of Factorial :: Parser}
  \input{code/factorial-main.dump-parsed.hs}
\end{frame}

\againframe{comp-pipeline}

\begin{frame}{Tracing The Compilation of Factorial :: Renamer}
  \input{code/factorial-main.dump-renamer.hs}
\end{frame}
...
\begin{frame}{Tracing The Compilation of Factorial :: Typechecker}
  \tiny
  \input{code/factorial-main.dump-typechecker.hs}
\end{frame}
...
\begin{frame}{Tracing The Compilation of Factorial :: Desugarer}
  \tiny
  \input{code/factorial-main.dump-ds1.hs}
\end{frame}

\begin{frame}{Tracing The Compilation of Factorial :: Desugarer}
  \tiny
  \input{code/factorial-main.dump-ds2.hs}
\end{frame}
...
\begin{frame}{Tracing The Compilation of Factorial :: Simplifier}
  \tiny
  \input{code/factorial-main.dump-simpl1.hs}
\end{frame}

\begin{frame}{Tracing The Compilation of Factorial :: Simplifier}
  \tiny
  \input{code/factorial-main.dump-simpl2.hs}
\end{frame}
...
\begin{frame}{Tracing The Compilation of Factorial :: Core Preparation}
  \tiny
  \input{code/factorial-main.dump-prep1.hs}
\end{frame}

\begin{frame}{Tracing The Compilation of Factorial :: Core Preparation}
  \tiny
  \input{code/factorial-main.dump-prep2.hs}
\end{frame}

\begin{frame}{Tracing The Compilation of Factorial :: Core Preparation}
  \tiny
  \input{code/factorial-main.dump-prep3.hs}
\end{frame}
...
\begin{frame}{Tracing The Compilation of Factorial :: STG}
  \tiny
  \input{code/factorial-main.dump-stg1.hs}
\end{frame}

\begin{frame}{Tracing The Compilation of Factorial :: STG}
  \tiny
  \input{code/factorial-main.dump-stg2.hs}
\end{frame}
...
\begin{frame}{Tracing The Compilation of Factorial :: Fragment of cmm output}
  \tiny
  \input{code/factorial-main.dump-cmm2.hs}
\end{frame}

\begin{frame}{Tracing The Compilation of Factorial :: Fragment of cmm output}
  \tiny
  \input{code/factorial-main.dump-cmm1.hs}
\end{frame}

\begin{frame}{Tracing The Compilation of Factorial :: Optimized cmm}
  \tiny
  \input{code/factorial-main.dump-opt-cmm.hs}
\end{frame}
...
\begin{frame}{Tracing The Compilation of Factorial :: Assembly}
  \tiny
  \input{code/factorial-main.dump-asm.hs}
\end{frame}
